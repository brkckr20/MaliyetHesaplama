...
namespace MaliyeHesaplama.userControls
{
    public partial class Uc_MaliyetHesaplama : System.Windows.Controls.UserControl, IPageCommands
    {
        ...
        string R(System.Windows.Controls.TextBox tb)
        {
            ...
            // Binlik ayıracı kaldır
            text = text.Replace(",", "").Replace(" ", ""); // boşluk da binlik olabilir

            // Eğer ondalık varsa nokta ile göster
            int lastDot = text.LastIndexOf('.');
            if (lastDot >= 0)
            {
                // Son noktadan sonrası ondalık
                string integerPart = text.Substring(0, lastDot);
                string decimalPart = text.Substring(lastDot + 1);
        ...
        public void Kaydet()
        {
            ...
            {
                {"Id",CPCId },{"CostId",Id},{"WC_Warp1", R(txtCozgu1Gramaj)},{"WC_Warp2", R(txtCozgu2Gramaj)},{"WC_Scarf1", R(txtAtki1Gramaj)},{"WC_Scarf2", R(txtAtki2Gramaj)},{"WC_Scarf3", R(txtAtki3Gramaj)},{"WC_Scarf4", R(txtAtki4Gramaj)},{"WC_Total", R(txtToplamGramaj)},{"YD_Warp1", R(txtCozgu1IpBoyText)},{"YD_Warp2", R(txtCozgu2IpBoyText)},{"YD_Scarf1", R(txtAtki1IpBoyText)},{"YD_Scarf2", R(txtAtki2IpBoyText)},{"YD_Scarf3", R(txtAtki3IpBoyText)},{"YD_Scarf4", R(txtAtki4IpBoyText)},{"YD_Result", R(txtIpBoySonuc)},{"YP_Warp1", R(txtCozgu1IpFiyText)},{"YP_Warp2", R(txtCozgu2IpFiyText)},{"YP_Scarf1", R(txtAtki1IpFiyText)},{"YP_Scarf2", R(txtAtki2IpFiyText)},{"YP_Scarf3", R(txtAtki3IpFiyText)},{"YP_Scarf4", R(txtAtki4IpFiyText)},{"YC_Warp1", R(txtCozgu1IpMal)},{"YC_Warp2", R(txtCozgu2IpMal)},{"YC_Scarf1", R(txtAtki1IpMal)},{"YC_Scarf2", R(txtAtki2IpMal)},{"YC_Scarf3", R(txtAtki3IpMal)},{"YC_Scarf4", R(txtAtki4IpMal)},{"YC_Result", R(txtToplamIpMal)}
            };
            ...
            {
                {"Id",CDId },{"CostId",Id},{"CD_WidthPull", Convert.ToDecimal(txtEndenCekmesi.Content ?? "0")},{"CD_HeightPull",R(txtBoydanCekmesi)},{ "CD_ScarfGr", R(txtAtkiGr)},{ "CD_WarpGr", R(txtCozguGr) }, { "CD_MtulGr", R(txtMtTulGr) },{ "CD_HashPouring", txtHasilDokmesi.Content },{ "CD_M2Gr", R(txtM2Gr) }, { "CD_1MtScarfCount",R(txt1MtAtkiSayisi) }, { "CD_CmFreauency",R(txtCmSiklik) }, { "CD_ReportScarfCount", R(txtRapordakiAtkiSayisi) },{ "CD_1ScarfCount",R(txt1AtkiSayisi) },{ "CD_2ScarfCount",R(txt2AtkiSayisi) },{ "CD_3ScarfCount",R(txt3AtkiSayisi) }, {"CD_1ScarfFrequency",R(txt1AtkiSayisiSonuc)},{"CD_2ScarfFrequency",R(txt2AtkiSayisiSonuc)},{"CD_3ScarfFrequency",R(txt3AtkiSayisiSonuc)},{"CD_Scarf1Kg",R(txtAtki1IplikHesabi)},{"CD_Scarf2Kg",R(txtAtki2IplikHesabi)},{"CD_Scarf3Kg",R(txtAtki3IplikHesabi)},{"CD_Scarf4Kg",R(txtAtki4IplikHesabi)},{"CD_Warp1Kg",R(txtCozgu1IplikHesabi)},{"CD_Warp2Kg",R(txtCozgu2IplikHesabi)},{"CD_WarpPulling", R(txtCozguCekmesi)},{"CD_OrderMeter", R(txtSiparisMetresi)},{"CD_TC_WireCount", R(txtTelSayisi)},{"CD_TC_TaharCost", R(txtTaharMaliyeti)},{"CD_TC_TaharCostAmount", R(txtTaharMaliyetiSonuc)},{"CD_TC_LamelCost", R(txtLamelMaliyeti)},{"CD_TC_LamelCostAmount", R(txtLamelMaliyetiSonuc)},{"CD_TC_CounterRest", R(txtTYGS)},{"CD_TC_CounterRestAmount", R(txtTYGSSonuc)},{"CD_TC_TotalCost", R(txtToplamMaliyet)},{"CD_TC_OrderMetraj", R(txtSiparisMetraji)},{"CD_TC_1MtCost", R(txt1MtDusenMaliyet)},{"CD_TC_1MtCostAmount", R(txt1MtDusenMaliyetSonuc)}/**/ // CD_Warp1Kg satırı sanırım convertdecimal yapınca düzeldi gibi ama kontrol etmemiz gerekecek kayıt yanlış formatta oluyor - 25-02-2026
            };
