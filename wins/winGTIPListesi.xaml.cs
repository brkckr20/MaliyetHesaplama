...
namespace MaliyeHesaplama.wins
{
    ...
    public partial class winGTIPListesi : Window
    {
        MiniOrm _orm = new MiniOrm();
        //private ICollectionView _collectionView;
        public int Id;
        public string Kodu, Adi, Aciklama;
        public bool SecimYapildi = false, Kullanimda;

        private List<ColumnSetting> columnSettings;
        private const string SCREEN_NAME = "GTIP Tanımları Listesi";
        private const string GRID_NAME = "gridGTIP";
        private int currentUserId = Properties.Settings.Default.RememberUserId;

        private void Window_Loaded(object sender, RoutedEventArgs e)
        {
            var source = _orm.GetAll<GTIP>("GTIP");
