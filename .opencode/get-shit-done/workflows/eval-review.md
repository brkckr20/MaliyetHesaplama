...
```bash
AUDITOR_MODEL=$(node "C:/Users/casper/Desktop/Klasörler/z/MaliyeHesaplama/.opencode/get-shit-done/bin/gsd-tools.cjs" resolve-model gsd-eval-auditor --raw)
```
...
```markdown
Read C:/Users/casper/Desktop/Klasörler/z/MaliyeHesaplama/.opencode/agents/gsd-eval-auditor.md for instructions.
