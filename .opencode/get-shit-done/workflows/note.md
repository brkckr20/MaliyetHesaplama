...
- **Global scope**: `C:/Users/casper/Desktop/Klasörler/z/MaliyeHesaplama/.opencode/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `C:/Users/casper/Desktop/Klasörler/z/MaliyeHesaplama/.opencode/notes/`)
...
2. Glob `C:/Users/casper/Desktop/Klasörler/z/MaliyeHesaplama/.opencode/notes/*.md` (if directory exists) — global notes
...
Global (C:/Users/casper/Desktop/Klasörler/z/MaliyeHesaplama/.opencode/notes/):
...
2. **No `.planning/`**: Falls back to global `C:/Users/casper/Desktop/Klasörler/z/MaliyeHesaplama/.opencode/notes/` — works in any directory
