...
<required_reading>
@C:/Users/casper/Desktop/Klasörler/z/MaliyeHesaplama/.opencode/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = C:/Users/casper/Desktop/Klasörler/z/MaliyeHesaplama/.opencode
                  → checks C:/Users/casper/Desktop/Klasörler/z/MaliyeHesaplama/.opencode/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = C:/Users/casper/Desktop/Klasörler/z/MaliyeHesaplama/.opencode/get-shit-done
                  → writes to C:/Users/casper/Desktop/Klasörler/z/MaliyeHesaplama/.opencode/get-shit-done/hooks/
...
@C:/Users/casper/Desktop/Klasörler/z/MaliyeHesaplama/.opencode/get-shit-done/references/thinking-models-debug.md
...
- Read @C:/Users/casper/Desktop/Klasörler/z/MaliyeHesaplama/.opencode/get-shit-done/references/common-bug-patterns.md
...
```bash
INIT=$(node "C:/Users/casper/Desktop/Klasörler/z/MaliyeHesaplama/.opencode/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "C:/Users/casper/Desktop/Klasörler/z/MaliyeHesaplama/.opencode/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "C:/Users/casper/Desktop/Klasörler/z/MaliyeHesaplama/.opencode/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
